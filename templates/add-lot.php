<main>
    ...
    <form class="form form--add-lot container <?= isset($errors) ? 'form--invalid' : false; ?>" action="add-lot.php"
        ...
        <div class="form__container-two">
            <div class="form__item <?= isset($errors['name']) ? 'form__item--invalid' : false; ?>">
            ...
            <div class="form__item <?= isset($errors['category']) ? 'form__item--invalid' : false; ?>">
                ...
                <span class="form__error"><?= $errors['category'] ?? null; ?></span>
            </div>
        </div>
        ...
        <div class="form__item form__item--file <?= isset($errors['lot-image']) ? 'form__item--invalid' : false; ?>">
            ...
            <span class="form__error"><?= $errors['lot-image'] ?? false; ?></span>
        </div>
